...
def main():
    ...
    parser.add_argument('--train_config', type=str, default='configs/train_test.config')
    ...
    a2c_trainer.a2c_run(train_episodes, 'train', episode=start_episode, resume=resume)
    # final test
    a2c_trainer.a2c_run(env.case_size['test'], 'test', episode=train_episodes)
